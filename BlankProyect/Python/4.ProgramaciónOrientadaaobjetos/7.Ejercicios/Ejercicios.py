...
# Un ejemplo de esto podria ser una clase Auto, una clase Motor y una clase Ruedas
# Que la clase auto llame a los metodos de estas dos clases y se ocupe de controlarlas

#2 Ejercicios Crear una herencia, lo pensare en videojuegos para que sea mas cercano a mi area de trabajo
# Quiero tener tres enemigos, Con lo que hemos visto pueden hacerlo con facilidad

#3 Ejercicio Polimorfismo, con el anterior ejercicio lo que quiero que hagan es que cuando invoquen el objeto, atraves de su variable padre, 
#Quiero que prueben invocar a los metodos de los hijos
# y que pueda crear a sus hijos de forma dinamica sin nesecidad de traer al hijo solo con el padre
...
# Cuando Crean tener los fundamentos claros, pruebence realizar estos ejercicios y comprueben hacerlos y terminarlos
# Recuerden lo que queremos es un MVP minimo producto viable, no hace falta ponerle graficos, ni pulirlo solo que funcione y que cumpla con lo minimo

#Ejercicios mas simples
#Calculadora, operaciones basicas, y devolver un resultado
#Lista de tareas, Agregar, Modificar tarea, eliminar tarea, Marcar tarea como completada
#Conversor de unidades, De dolares a su diviza, de metros a centimetros, grados celcius a farenheit, agregar un pequeño menu de seleccion de la unidad a convertir, cuatro opciones
#Generdor de contraseñas, generar una contraseña automatica, manualmente, Establecer reglas longitud, minuscula y mayuscula, numero y caracteres especiales
